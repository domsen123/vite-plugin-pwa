  ...
  return {
    ...
    generateBundle(_, bundle) {
      ...
      bundle['registerServiceWorker.js'] = {
        ...
        type: 'asset',
        name: undefined,
        source: `if('serviceWorker' in navigator) { window.addEventListener('load', () => { navigator.serviceWorker.register('${join(
          basePath,
    ...
    buildEnd() {
      ...
      if (strategies === 'generateSW') generateSW(resolvedOptions!.workbox);
